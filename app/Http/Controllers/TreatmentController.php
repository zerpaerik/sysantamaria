...
class TreatmentController extends Controller
{
  ...
  //  ->groupBy('pacienteId')
	...
	Treatment::create([
      ...
      "exac_eval" => str_replace(["[", "]", '"', ","], ["", ".", "", ", "], json_encode($request->exac_eval)),
      "inicio_eval" =>            $request->inicio_eval,
      "inicio_tiempo_eval" =>            $request->inicio_tiempo_eval,
      "dolor_eval" => str_replace(["[", "]", '"', ","], ["", ".", "", ", "], json_encode($request->dolor_eval)),
      "retraccion_eval" => str_replace(["[", "]", '"', ","], ["", ".", "", ", "], json_encode($request->retraccion_eval)),
      ...
      "rusa_corriente_trat" => str_replace(["[", "]", '"', ","], ["", ".", "", ", "], json_encode($request->rusa_corriente_trat)),
      ...
      "magneto" => str_replace(["[", "]", '"', ","], ["", ".", "", ", "], json_encode($request->magneto)),
     ...
     // "diagnostico_zona_eval" => $request->diagnostico_zona_eval,
      ...
      "intensidad_comp" => $request->intensidad_comp,
      ...
      "diagnostico_cie_eval" => $request->diagnostico_cie_eval
    ]);
