            ...
            <div id="servicios" class="embed ">
                ...
                <div id="servicios_template" class="template row">
                    ...
                    <div class="col-sm-2">
                      ...
                      <input id="servicios_#index#_monto" name="monto_s[servicios][#index#][monto] type="text" class="number form-control monto" placeholder="Monto" data-toggle="tooltip" data-placement="bottom" title="Monto" value="0.00" disabled="">
                    </div>
            ...
            <div id="paquetes" class="embed ">
                ...
                <div id="paquetes_template" class="template row">
                    ...
                    <div class="col-sm-2">
                      ...
                      <input id="paquetes_#index#_monto" name="monto_p[paquetes][#index#][monto] type="text" class="number form-control montop" placeholder="Monto" data-toggle="tooltip" data-placement="bottom" title="Monto" value="0.00" disabled="">
                    </div>
