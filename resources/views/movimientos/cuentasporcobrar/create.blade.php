	...
	<div class="col-xs-12">
		<div class="box">
				<div class="box-name">
					...
					<span><strong>Agregar Cuenta Pendiente</strong></span>
				</div>
			<div class="box-content">
				<h4 class="page-header"></h4>
				<form class="form-horizontal" role="form" method="post" action="guardar-cuentasporcobrar">
