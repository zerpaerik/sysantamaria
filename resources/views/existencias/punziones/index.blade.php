		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Listado de Punziones</span>
					<a href="{{route('punziones.create')}}" class="btn btn-success">Agregar</a>
			...
			{!! Form::open(['method' => 'get', 'route' => ['punziones.index']]) !!}
			...
			<div class="row">
				<div class="col-md-2">
				<strong>Total:</strong>{{$pun->monto}} Soles
			   </div>

			   <div class="col-md-2">
				<strong>Cantidad:</strong>{{$cantidad->cantidad}} Ventas
			   </div>
