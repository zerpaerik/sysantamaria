	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="post" action="punzion/create">
					{{ csrf_field() }}
			  ...
			  <label class="col-sm-1 control-label">TipoIngreso</label>
						<div class="col-sm-3">
          ...
          <div class="form-group form-inline">
            <div class="col-sm-8 col-sm-offset-7">
              ...
              <input type="text" name="total_a" class="number form-control" value="0.00" id="total_a" readonly="readonly" style="width: 150px">
						...
						<a href="{{route('punziones.index')}}" style="margin-left:15px; margin-top: 20px;" class="col-sm-2 btn btn-danger">Volver</a>
					</div>			
				</form>	
			</div>
		</div>
